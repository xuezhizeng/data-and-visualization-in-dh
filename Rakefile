...
task :syllabus_cat do
  sh %[cd source; cat index.md assignments.md schedule.md policies.md > ../religion-capitalism.print-syllabus.md]
end

task :syllabus_pdf do
  sh %[pandoc religion-capitalism.print-syllabus.edited.md -o religion-capitalism.print-syllabus.pdf]
end
